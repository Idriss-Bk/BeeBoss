...
const Achivements = () => {
    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          gsap.fromTo('.achievement-title', { opacity: 0, y: 20 }, { opacity: 1, y: 0, duration: 1 });
          gsap.fromTo('.achievement-card', { opacity: 0, y: 20 }, { opacity: 1, y: 0, duration: 1, stagger: 0.3 });
  ...
  return (
    <div ref={achievementsRef} className="min-h-screen flex flex-col items-center py-20 bg-white">
      <div className={`${fraunces.variable} font-fraunces font-light text-center text-6xl mb-12 achievement-title`}>
      ...
      <div className="achievements-section grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-7xl">
        <div className="achievement-card bg-gray-100 p-8 rounded-full text-center">
          <div className="text-6xl bg-yellow-100 p-5 rounded-full mb-4 flex gap-8">
            <RiCodeAiLine />
            <span className='text-2xl font-fraunces flex justify-center items-center text-center'>Over 500K Stores Created</span>
          </div>
        ...
        <div className="achievement-card bg-gray-100 p-8 rounded-full text-center">
          <div className="text-6xl bg-yellow-100 p-5 rounded-full mb-4 flex gap-8">
            <BiHappyBeaming />
            <span className='text-2xl font-fraunces flex justify-center items-center text-center'>98% Customer Satisfaction</span>
          </div>
        ...
        <div className="achievement-card bg-gray-100 p-8 rounded-full text-center">
          <div className="text-6xl bg-yellow-100 p-5 rounded-full mb-4 flex gap-8">
            <GiMoneyStack />
            <span className='text-2xl font-fraunces flex justify-center items-center text-center'>+$16 Million in Revenue</span>
          </div>
        ...
        <div className="achievement-card bg-gray-100 p-8 rounded-full text-center">
          <div className="text-6xl bg-yellow-100 p-5 rounded-full mb-4 flex gap-8">
            <BiWorld />
            <span className='text-2xl font-fraunces flex justify-center items-center text-center'>Global Reach: 50+ Countries</span>
          </div>
